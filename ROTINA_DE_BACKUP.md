...
### 5.1 Grupos/contatos dos Polos (cursos)
- Polo Recife Estratégia Educação — JID: **120363369341436636@g.us**
- Polo UNICORP — Contato: **Cinthia Eduarda (Gestora)** +55 83 8818-3895
...
### 5.2 Polo UNICORP — Drive de materiais (usar sempre o link mais recente; não filtrar dentro do drive)
...
### 5.3 Polo UNICORP — Materiais gerais de divulgação
...
### 5.4 Polo UNICORP — Credenciamentos oficiais
...
### 5.5 Polo UNICORP — Informativo EJA (início 01/02)
...
### 5.6 Arquivos recebidos (salvos localmente)
